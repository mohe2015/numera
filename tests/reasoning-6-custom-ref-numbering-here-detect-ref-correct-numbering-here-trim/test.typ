// The numbering is able to detect whether it was called from an equation or ref context to render the numbering differently. here() works again. Plain numberings trim for refs.
